        ...
        <div className="max-w-2xl mx-auto">
          ...
          <ScrollFadeIn delay="animate-delay-200">
            ...
            >
              ...
              <button
                onClick={copyEmail}
                className="w-full flex items-center justify-center gap-2 px-6 py-3 text-sm font-medium rounded-md border transition-colors hover:border-[var(--border-hover)]"
            ...
            <div className="space-y-3 mb-12">
              {CONTACT_INFO.map((item) => (
                <a
                  ...
                  className="flex items-center gap-3 p-3 rounded-md border transition-colors hover:border-[var(--border-hover)]"
                  style={{ borderColor: "var(--border)" }}
                >
              ...
              {FAQ.map((item, i) => (
                ...
                >
                  <button
                    ...
                    className="w-full flex items-center justify-between px-4 py-3 text-sm text-left font-medium hover:bg-[var(--bg-secondary)] transition-colors"
                  >
                    {item.q}
                    <svg
